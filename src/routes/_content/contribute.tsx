  ...
  return (
    <main className="flex flex-col gap-8 [&>article]:flex [&>article]:flex-col [&>article]:gap-4">
      ...
      <article>
        ...
        <Text>
          We currently store event information in a JSON file. JSON is a textual
          data format that is easy for both humans and computers to read. The
          list of events can be modified by{" "}
          <Link
            className="text-pink-9"
            element="a"
        ...
        <ul className="list-inside list-disc">
          ...
          <Text element="li">
            A slug (unique identifier) for the event. Used to uniquely identify
            each event, and is typically made by turning all letters lowercase
          ...
          <Text element="li">
            ...
            For example{" "}
            <code className="rounded-sm bg-gray-5 p-1 text-sm">Asia/Tokyo</code>
            .
          </Text>
          <Text element="li">
          ...
          <Text element="li">
            A human-readable address of the venue or location the show is being
            hosted at.
          </Text>
        </ul>

        <Text>Additionally, the event may have these optional attributes:</Text>

        <ul className="list-inside list-disc">
          <Text element="li">A link to the event location on Google Maps.</Text>
          <Text element="li">A link to the event location on Apple Maps.</Text>
        </ul>
      </article>
